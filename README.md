...
## Citing
This covers all methods developed for the "Hybridizing TPOT with Bayesian Optimization" paper, by Kenny et al., to appear in the proceedings of GECCO 2023, Lisbon.
