...
class Objective(object):
    ...
    '''
    def __init__(self, po, ind_idx, X, y, n_evals, discrete_mode=True, 
...
class TPOT_BO_Handler(object):
    ''' Class to interface with TPOT object and optuna library
    '''
    def __init__(self, tpot, vprint=u.Vprint(1), discrete_mode=True):
    ...
    def optimise(self, ind_idx, X_train, y_train, n_evals, discrete_mode=True, seed_samples=[], skip_params=[], timeout_trials=100):
        ...
        for seed_sample in seed_samples:
            if discrete_mode:
                ...
                trial = make_optuna_trial_cont(seed_sample[0], seed_sample[1],skip_params)
